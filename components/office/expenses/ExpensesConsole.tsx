                ...
                <section className="mx-auto mt-5 max-w-6xl rounded-[30px] border border-emerald-200 bg-gradient-to-br from-white via-emerald-50 to-cyan-50 p-4 shadow-2xl shadow-slate-950/15">
                    ...
                    <div className="mt-4 grid gap-3 md:grid-cols-3">
                        ...
                        <BalanceCard
                            ...
                            hint={cashProjection.projectedOfficeCashAfterPendingExpenses < 0 ? `Cash shortfall: ${money(Math.abs(cashProjection.projectedOfficeCashAfterPendingExpenses))}` : "Current Balance - Pending Expenses"}
