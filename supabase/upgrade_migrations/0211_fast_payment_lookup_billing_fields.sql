-- Expose billing-day fields in the fast Payment Entry room lookup.
-- Payment Entry must read the same saved billing_day it updates.

drop function if exists public.lookup_payment_room_fast(uuid, uuid, text, date, boolean);
